            ...
            <div class="row mb2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="?page=lokasiread">Karywan</a></li>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action method="POST">
                                        ...
                                        <input type="hidden" value="<?php echo $id ?>" name="karyawan_id">
                                        <button type="submit" class="btn btn-danger btn-sm mr-1" onclick="javascript: return confirm('Konfirmasi data akan dihapus');">
